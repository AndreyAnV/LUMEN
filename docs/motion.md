...
- `seamless_video_loop_crossfade_system.txt`: reviewed and deferred because `assets/video/hero-dental.mp4` is absent. The poster and current video-loading safeguards remain in place.
